...
class DefaultTrainer(TrainerBase):
    ...
    def build_model(cls, cfg):
        ...
        #    if "box_head" or "box_predictor" in name:  # "mask_head" refers to the mask head part of the model
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        Overwrite it if you'd like a different data loader.
        """
        return build_detection_test_loader(cfg, dataset_name,batch_size=1 )
