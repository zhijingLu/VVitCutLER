...
def convert_PIL_to_numpy(image, format,file_name):
    """
    ...
    # handle formats not supported by PIL
        ...
        print(f"Cannot process image {file_name}: {e}")
        return None
...
def read_image(file_name, format=None):
    ...
    with PathManager.open(file_name, "rb") as f:
        ...
        return convert_PIL_to_numpy(image, format,file_name)
...
def annotations_to_instances(annos, image_size, mask_format="polygon"):
    ...
    #print('target:::',target.gt_classes)
