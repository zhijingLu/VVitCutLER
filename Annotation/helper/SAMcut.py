...
def SAM_cut(image_rgb,boxes, predictor= None,padding=(50, 50, 50, 50),device='cuda'):
    
    if predictor:
        with torch.inference_mode(), torch.autocast("cuda", dtype=torch.bfloat16):
            padded_image = ImageOps.expand(image_rgb, border=padding, fill=(0, 0, 0))
            ...
            for box in boxes:
                ...
                best_mask = masks[best_idx] # 形状 (H, W)
                ...
                polygons,bbox = masks_to_polygons(masks,padding)
